...
export interface ApiProductImageProductImage
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    img: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios', true>;
    ListImg: Schema.Attribute.Relation<'manyToOne', 'api::product.product'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiProductSaleProductSale extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    percent_discount: Schema.Attribute.Decimal;
    products: Schema.Attribute.Relation<'oneToMany', 'api::product.product'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    name_category: Schema.Attribute.Relation<
      'manyToOne',
      'api::category.category'
    >;
    prices: Schema.Attribute.Decimal;
    ...
    product_images: Schema.Attribute.Relation<
      ...
      'api::product-image.product-image'
    >;
    product_sale: Schema.Attribute.Relation<
      'manyToOne',
      'api::product-sale.product-sale'
    >;
    publishedAt: Schema.Attribute.DateTime;
